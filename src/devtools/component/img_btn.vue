...
type ClickFun = (payload: MouseEvent) => void;
...
export default defineComponent({
    ...
    setup: (props) => {
        let imgColor = ref(props.color);

        onMounted(() => {
            // imgColor.value = props.color;
        })

        const mouseEnter = () => {
            imgColor.value = props.hoverColor;
        }
        ...
        return {
            imgColor, mouseEnter, mouseLeave
        }
    }
